...
///
/// MyDataTableSource objects are expected to be long-lived, not recreated with
/// each build.
///
/// If a [MyDataTableSource] is used with a [PaginatedDataTable] that supports
...
abstract class MyDataTableSource extends ChangeNotifier {
  ...
  /// consistent for a given [MyDataRow] regardless of the sort order (i.e. the
  /// key represents the data's identity, not the row position).
  ///
  /// The [MyDataRow.byIndex] constructor provides a convenient way to construct
  /// [MyDataRow] objects for this method's purposes without having to worry about
  ...
  ///
  /// Selected rows are those whose [MyDataRow.selected] property is set to true.
